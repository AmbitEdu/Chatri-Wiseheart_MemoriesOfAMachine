#  Author: Klaudia Nazarko  (https://github.com/klaudia-nazarko/nlg-text-generation/blob/main/Text.py)
#  Minor modifications by Seth Wiseheart

import re

class Text:
    def __init__(self, input_text, token2ind=None, ind2token=None, reverse=False):
        self.content = input_text
        self.tokens, self.tokens_distinct = self.tokenize(reverse)
    ...
    def tokenize(self, reverse=False):
        self.preprocess()
