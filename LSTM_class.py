#  Author: Klaudia Nazarko (https://github.com/klaudia-nazarko/nlg-text-generation/blob/main/LSTM_class.py)
...
class ModelPredict():
    ...
    def generate_sequence(self, k, append=False, temperature=1, ret_unprocessed=False):
        for i in range(k):
